Download data from scout 4.6.7
==============================

Getting data from 20CR scout runs is much more complex than :doc:`getting it from the released version <get_data_v3>`. Scout runs are not post-processed or distributed, so you need to log on to `Cori <https://docs.nersc.gov/systems/cori/>`_ and extract the data yourself.
...
.. literalinclude:: ../../get_data/extract_data_467.sh
...
.. literalinclude:: ../../get_data/get_data_467.py
