...
# Get the mean PRATE over the Yangtze basin for a selected month.
...
parser.add_argument("--opdir", help="Directory for output files",
                    default="%s/20CR/version_3/analyses/Yangtze_catchment_ts/PRATE" % \
                                           os.getenv('SCRATCH'),
...
for member in range(80):
    ...
    # Get the monthly PRATE field
    pField = iris.load_cube(
        '%s/20CR/version_3/monthly/%04d/PRATE.%04d.mnmean_mem%03d.nc' 
...
pickle.dump(mPRATE,open(cspf,'wb'))
