...
./plot_ts_full.py --version=3 --comparison=0.0.1  --comparison2=4.6.1 --var=PRMSL --yscale=0.01
./plot_ts_full_anomaly.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=PRMSL --yscale=0.01

./plot_ts_full.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=PRATE --yscale=1000
./plot_ts_full_anomaly.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=PRATE --yscale=1000

./plot_ts_full.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=TMP2m
./plot_ts_full_anomaly.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=TMP2m

./plot_ts_full.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=PWAT
./plot_ts_full_anomaly.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=PWAT

./plot_ts_full.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=WEASD --ymax=35
./plot_ts_full_anomaly.py --version=3 --comparison=0.0.1 --comparison2=4.6.1 --var=WEASD --ymax=25
