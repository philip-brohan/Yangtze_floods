...
parser.add_argument("--opdir", help="Directory for output files",
                    default="%s/20CR/version_4.6.1/analyses/Stripes_daily/TMP2m" % \
                                           os.getenv('SCRATCH'),
...
from get_sample_461 import get_sample_cube
...
climatology.coord('latitude').coord_system=coord_s
climatology.coord('longitude').coord_system=coord_s
